    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <a title="Next.js documentation" href="https://nextjs.org/docs/getting-started" target="_blank" rel="noopener noreferrer">
            Next.js
          </a>{' '}
          application.
          <br />
        ...
        <div className={styles.grid}>
          ...
          <article className={styles.card}>
            <h2>Timing</h2>
            <p>
              We recommend 4 hours for this test. You are free to spend more (or less) time, let us know how much time did you spend.
            </p>
          </article>
        </div>
      </main>
